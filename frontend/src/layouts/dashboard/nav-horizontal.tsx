...
export const NavHorizontal: React.FC<DashboardNavigationProps> = ({ isAdmin, hasUnreadChatMessage, onNavigate, navColor = 'integrate' }) => {
  ...
  return <Box component="nav" aria-label="主导航" sx={{ display: { xs: 'none', lg: 'flex' }, minHeight: 72, px: 'var(--dh-content-gutter)', alignItems: 'center', gap: 3, borderBottom: 1, borderColor: 'divider', bgcolor: navColor === 'apparent' ? 'background.paper' : 'background.default' }}>
