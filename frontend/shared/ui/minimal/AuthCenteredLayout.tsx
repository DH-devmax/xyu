...
export const MinimalAuthCenteredLayout: React.FC<MinimalAuthCenteredLayoutProps> = ({
  ...
  <>
    ...
    <Box
      component="main"
      className={mergeClasses(['minimal-auth-centered', className])}
    ...
    >
      <Box
        component="header"
        className="minimal-auth-centered__header"
        sx={{
          position: 'relative',
          zIndex: 1,
          width: '100%',
      ...
      <Box
        component="section"
        className="minimal-auth-centered__content"
        sx={[
          {
            position: 'relative',
            zIndex: 1,
