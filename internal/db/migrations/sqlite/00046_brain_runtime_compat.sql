...
CREATE INDEX IF NOT EXISTS idx_brain_sessions_user_updated ON brain_sessions(user_id, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_brain_sessions_account_chat ON brain_sessions(cookie_id, chat_id);
...
CREATE INDEX IF NOT EXISTS idx_brain_turns_session_created ON brain_turns(session_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_brain_turns_status_updated ON brain_turns(status, updated_at);
